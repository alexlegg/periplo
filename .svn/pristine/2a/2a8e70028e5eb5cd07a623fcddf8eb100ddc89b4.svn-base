...
//
template <class T, class C>
T & periplo::SplayTree< T, C >::insert( T & x )
{
  assert( initialized );
...
//
template <class T, class C>
void periplo::SplayTree< T, C >::remove( T & x )
{
  assert( initialized );
...
//
template <class T, class C>
T & periplo::SplayTree< T, C >::find( T & x )
{
  assert( initialized );
...
//
template <class T, class C>
void periplo::SplayTree< T, C >::splay( T & t, Bnode * & n )
{
  assert( initialized );
...
//
template <class T, class C>
void periplo::SplayTree< T, C >::deleteTree()
{
  assert( initialized );
...
template <class T, class C>
void periplo::SplayTree<T,C>::printTree(Bnode* t)
{
...
template <class T, class C>
void periplo::SplayTree< T, C>::printTree()
{
...
template <class T, class C>
void periplo::SplayTree< T, C >::printStatistics( ostream & os )
{
  os << "#" << endl;
...
template <class T, class C>
void periplo::SplayTree<T,C>::debug(const T elems[], int size)
{
  assert( isEmpty() );
  if (size == 0) return;
...
template <class T, class C>
void periplo::SplayTree<T,C>::perf( ostream & os ) {
  os << "#" << endl;
  os << "# Total bnodes..........: " << size << endl;
  os << "# Max depth.............: ";
  periplo::minisat::vec<SplayTreePair> queue;
  SplayTreePair p;
  p.node = root;
  p.depth = 0;
  queue.push(p);
